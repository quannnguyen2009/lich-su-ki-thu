...
function CourseCard({ data, onClick, gridNumber }: ICourseCardProps) {
  const getBadgeColor = () => {
    switch (data.label) {
      case 'new':
        return 'bg-[#34D399]';
  ...
  return (
    <div
      onClick={onClick}
      role='presentation'
      className='p-2 cursor-pointer bg-white flex flex-col rounded-2xl overflow-hidden shadow-md'
    >
      ...
      <div className='p-4 bg-white'>
        <div className='flex flex-wrap items-center gap-2 mb-2 '>
          ...
          <p className='whitespace-nowrap'>({data?.reviewCount} Đánh giá)</p>
        </div>
